...
//[[Rcpp::export]]
List GxE_logit_wald_dosage(CharacterVector filename, NumericVector Y, NumericMatrix X, int df, int beg, int end, double tol) {
...
RcppExport SEXP gg_GxE_logit_wald_dosage(SEXP filenameSEXP, SEXP YSEXP, SEXP XSEXP, SEXP dfSEXP, SEXP begSEXP, SEXP endSEXP, SEXP tolSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(GxE_logit_wald_dosage(filename, Y, X, df, beg, end, tol));
