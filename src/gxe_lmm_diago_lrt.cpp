...
//[[Rcpp::export]]
List GxE_lmm_lrt_1df(XPtr<matrix4> pA, NumericVector mu, NumericVector Y, NumericMatrix X, 
  ...
  diag_full_likelihood<MATRIX, VECTOR, scalar> A0(p, y, x1, sigma);
  ...
  for(int i = beg; i <= end; i++) {
    ...
    for(int ii = 0; ii < pA->true_ncol-1; ii++) {
      ...
      for(int ss = 0; ss < 4; ss++) {
		...
		INT(4*ii+ss) = SNP(4*ii+ss)*x0(4*ii+ss,r-3);
        x >>= 2;
      }
    }
    ...
    H2(i-beg) = h2;
    LRT(i-beg) = 2*(A.likelihood() - A0.likelihood());
  }
...
List GxE_lmm_lrt_2df(XPtr<matrix4> pA, NumericVector mu, NumericVector Y, NumericMatrix X, 
                  int p, NumericVector Sigma, NumericMatrix U, int beg, int end, double tol) {
...
List GxE_lmm_lrt_3df(XPtr<matrix4> pA, NumericVector mu, NumericVector Y, NumericMatrix X, 
                  int p, NumericVector Sigma, NumericMatrix U, int beg, int end, double tol) {
...
RcppExport SEXP gg_GxE_lmm_lrt_1df(SEXP pASEXP, SEXP muSEXP, SEXP YSEXP, SEXP XSEXP, SEXP pSEXP, SEXP SigmaSEXP, SEXP USEXP, SEXP begSEXP, SEXP endSEXP, SEXP tolSEXP) {
BEGIN_RCPP
    SEXP __sexp_result;
    {
        ...
        List __result = GxE_lmm_lrt_1df(pA, mu, Y, X, p, Sigma, U, beg, end, tol);
...
RcppExport SEXP gg_GxE_lmm_lrt_2df(SEXP pASEXP, SEXP muSEXP, SEXP YSEXP, SEXP XSEXP, SEXP pSEXP, SEXP SigmaSEXP, SEXP USEXP, SEXP begSEXP, SEXP endSEXP, SEXP tolSEXP) {
BEGIN_RCPP
    SEXP __sexp_result;
    {
        Rcpp::RNGScope __rngScope;
        ...
        Rcpp::traits::input_parameter< int >::type end(endSEXP );
        Rcpp::traits::input_parameter< double >::type tol(tolSEXP );
        List __result = GxE_lmm_lrt_2df(pA, mu, Y, X, p, Sigma, U, beg, end, tol);
        PROTECT(__sexp_result = Rcpp::wrap(__result));
    }
    UNPROTECT(1);
    return __sexp_result;
...
RcppExport SEXP gg_GxE_lmm_lrt_3df(SEXP pASEXP, SEXP muSEXP, SEXP YSEXP, SEXP XSEXP, SEXP pSEXP, SEXP SigmaSEXP, SEXP USEXP, SEXP begSEXP, SEXP endSEXP, SEXP tolSEXP) {
BEGIN_RCPP
    SEXP __sexp_result;
    {
        Rcpp::RNGScope __rngScope;
        ...
        Rcpp::traits::input_parameter< int >::type end(endSEXP );
        Rcpp::traits::input_parameter< double >::type tol(tolSEXP );
        List __result = GxE_lmm_lrt_3df(pA, mu, Y, X, p, Sigma, U, beg, end, tol);
        PROTECT(__sexp_result = Rcpp::wrap(__result));
    }
    UNPROTECT(1);
    return __sexp_result;
