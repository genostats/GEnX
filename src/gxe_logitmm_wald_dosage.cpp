...
//[[Rcpp::export]]
List GxE_logitmm_wald_dosage(CharacterVector filename, NumericVector Y, NumericMatrix X, 
...
RcppExport SEXP gg_GxE_logitmm_wald_dosage(SEXP filenameSEXP, SEXP YSEXP, SEXP XSEXP, SEXP KSEXP, SEXP dfSEXP, SEXP begSEXP,
...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(GxE_logitmm_wald_dosage(filename, Y, X, K, df, beg, end, tol));
